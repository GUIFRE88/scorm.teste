...
(lib.maoEnvelope = function() {
	this.initialize(img.maoEnvelope);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,580,387);// helper functions:
...
(lib.Symbol36 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.text = new cjs.Text("Conflito de interesses", "36px 'EDP Preon Hair'", "#DF0B14");
...
}).prototype = getMCSymbolPrototype(lib.Symbol36, new cjs.Rectangle(-321.9,-18.2,643.9,54.400000000000006), null);
...
(lib.Symbol34 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#DF0B14").ss(2).p("EgrvgsMMBXfAAAMAAABYZMhXfAAAg");

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#DF0B14").s().p("EgrvAsNMAAAhYZMBXfAAAMAAABYZg");

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol34, new cjs.Rectangle(-280.9,-283.9,561.9,567.8), null);
...
(lib.Symbol32 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.text = new cjs.Text("Mesmo que não haja uma situação real de conflito de interesse, outras pessoas podem entender que o cliente que deu o “agrado” recebeu ou receberá vantagens e não podemos tratar clientes em condições desiguais. ", "18px 'EDP Preon'", "#FFFFFF");
	this.text.lineHeight = 27;
	this.text.lineWidth = 530;
	this.text.parent = this;
	this.text.setTransform(-264.95,-66.95);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#DF0B14").ss(2).p("EgrvgMeMBXfAAAIAAY9MhXfAAAg");
	this.shape.setTransform(0,0.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("EgrvAMfIAA49MBXfAAAIAAY9g");
	this.shape_1.setTransform(0,0.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol32, new cjs.Rectangle(-280.9,-80.8,561.9,161.7), null);
...
(lib.Symbol31 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.text = new cjs.Text("Não aceitar cortesias pela prestação de serviços a clientes, no decurso normal das atividades. Esta prática pode representar aparente ou real situação de conflito de interesses.", "18px 'EDP Preon'", "#333333");
	this.text.lineHeight = 27;
	this.text.lineWidth = 530;
	this.text.parent = this;
	this.text.setTransform(-264.95,-53.4);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#DF0B14").ss(2).p("EgrvgKUMBXfAAAIAAUpMhXfAAAg");
	this.shape.setTransform(0,-0.025);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFFFF").s().p("EgrvAKVIAA0pMBXfAAAIAAUpg");
	this.shape_1.setTransform(0,-0.025);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol31, new cjs.Rectangle(-280.9,-67.1,561.9,134.2), null);
...
(lib.__balaocopy7 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(18.4642,65.875,1,1.133,0,-28.0456,0);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F0F0F0").s().p("AiEiKIDSiBIFnAAIk5CFIowGSg");
	this.shape_1.setTransform(30.6914,59.45,1,1.133,0,-28.0456,0);

	this.caixaTexto = new cjs.Text("Você sabe o que é um conflito de interesse? Trata-se de uma situação gerada pelo confronto do interesse particular de maneira que, este confronto, comprometa ou influencie o interesse público ou privado. Por exemplo: ", "18px 'EDP Preon'", "#333333");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
	this.caixaTexto.lineWidth = 351;
	this.caixaTexto.parent = this;
	this.caixaTexto.setTransform(-254.55,-159.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("A6UxfMA0pAAKQDIAAAADIIAAclQAADIjIAAMg0pgAKQjIAAAAjIIAA8lQAAjIDIAAg");
	this.shape_2.setTransform(-81.225,-65.3);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F0F0F0").s().p("A6URWQjIAAAAjIIAA8lQAAjIDIAAMA0pAAKQDIAAAADIIAAclQAADIjIAAg");
	this.shape_3.setTransform(-81.225,-65.3);
...
}).prototype = getMCSymbolPrototype(lib.__balaocopy7, new cjs.Rectangle(-271.2,-178.8,380,266.5), null);
...
(lib.Symbol30 = function(mode,startPosition,loop) {
	...
	mask._off = true;
	var mask_graphics_16 = new cjs.Graphics().p("EgrvgLhIAAgRMBXfAAAIAAARg");
	var mask_graphics_17 = new cjs.Graphics().p("EgrvgK0IAAg+MBXfAAAIAAA+g");
	var mask_graphics_18 = new cjs.Graphics().p("EgrvgIsIAAjGMBXfAAAIAADGg");
	var mask_graphics_19 = new cjs.Graphics().p("EgrvgFJIAAmpMBXfAAAIAAGpg");
	var mask_graphics_20 = new cjs.Graphics().p("EgrvgAMIAArmMBXfAAAIAALmg");
	var mask_graphics_21 = new cjs.Graphics().p("EgrvAGKIAAx8MBXfAAAIAAR8g");
	var mask_graphics_22 = new cjs.Graphics().p("EgrvAMsIAA5XMBXfAAAIAAZXg");
	var mask_graphics_23 = new cjs.Graphics().p("EgrvAP4IAA/vMBXfAAAIAAfvg");
	var mask_graphics_24 = new cjs.Graphics().p("EgrvASXMAAAgktMBXfAAAMAAAAktg");
	var mask_graphics_25 = new cjs.Graphics().p("EgrvAUIMAAAgoPMBXfAAAMAAAAoPg");
	var mask_graphics_26 = new cjs.Graphics().p("EgrvAVMMAAAgqXMBXfAAAMAAAAqXg");
	var mask_graphics_27 = new cjs.Graphics().p("EgrvAViMAAAgrDMBXfAAAMAAAArDg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(16).to({graphics:mask_graphics_16,x:0,y:-75.5381}).wait(1).to({graphics:mask_graphics_17,x:0,y:-75.5378}).wait(1).to({graphics:mask_graphics_18,x:0,y:-75.5367}).wait(1).to({graphics:mask_graphics_19,x:0,y:-75.5349}).wait(1).to({graphics:mask_graphics_20,x:0,y:-75.5324}).wait(1).to({graphics:mask_graphics_21,x:0,y:-75.5291}).wait(1).to({graphics:mask_graphics_22,x:0,y:-69.8116}).wait(1).to({graphics:mask_graphics_23,x:0,y:-49.4314}).wait(1).to({graphics:mask_graphics_24,x:0,y:-33.5802}).wait(1).to({graphics:mask_graphics_25,x:0,y:-22.2579}).wait(1).to({graphics:mask_graphics_26,x:0,y:-15.4645}).wait(1).to({graphics:mask_graphics_27,x:0,y:-13.2}).wait(42));

	// Layer_4
	this.instance = new lib.maoEnvelope();
	this.instance.parent = this;
	this.instance.setTransform(-289,-186);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(16).to({_off:false},0).wait(53));

	// Layer_1
	this.instance_1 = new lib.Symbol34();
	this.instance_1.parent = this;
	this.instance_1.setTransform(-278.2,0.05,0.0064,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).to({scaleX:1,x:0},14,cjs.Ease.quadInOut).wait(55));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-281,-283.8,562,567.8);
...
// stage content:
(lib.edp_compliance17 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(41).call(this.frame_41).wait(1).call(this.frame_42).wait(32).call(this.frame_74).wait(1).call(this.frame_75).wait(13).call(this.frame_88).wait(1).call(this.frame_89).wait(1).call(this.frame_90).wait(1));

	// Layer_5
	this.instance = new lib.btnSeguir();
	this.instance.parent = this;
	this.instance.setTransform(389.9,276.15,0.8047,0.8047,0,0,0,25.6,27.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(41).to({_off:false},0).to({_off:true},1).wait(32).to({_off:false,x:999,y:175.75},0).to({_off:true},1).wait(13).to({_off:false,x:389.9,y:246.15},0).to({_off:true},1).wait(2));

	// Layer_6
	this.instance_1 = new lib.__balaocopy7();
	this.instance_1.parent = this;
	this.instance_1.setTransform(171.05,453.2,1,1,0,0,0,-110,222.4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(36).to({_off:false},0).to({_off:true},53).wait(2));
	...
	this.instance_2.parent = this;
	this.instance_2.setTransform(744.05,559.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(75).to({_off:false},0).to({y:547.5,alpha:1},11).to({_off:true},3).wait(2));

	// Layer_12
	this.instance_3 = new lib.Symbol31();
	this.instance_3.parent = this;
	this.instance_3.setTransform(744.05,175.3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(53).to({_off:false},0).to({y:125.7,alpha:1},10,cjs.Ease.quadInOut).to({_off:true},26).wait(2));

	// Layer_11
	this.instance_4 = new lib.Symbol30("synched",0,false);
	this.instance_4.parent = this;
	this.instance_4.setTransform(744.05,343.45);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(42).to({_off:false},0).to({_off:true},47).wait(2));

	// Layer_4
	this.instance_5 = new lib.Symbol36();
	this.instance_5.parent = this;
	this.instance_5.setTransform(512,6.65);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(30).to({_off:false},0).to({y:26.65,alpha:1},11,cjs.Ease.get(1)).to({_off:true},48).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get(this.moco).to({regX:149.7,regY:211.1,scaleX:0.9061,scaleY:0.9061,x:305.9,y:438.75},29,cjs.Ease.quadInOut).to({_off:true},60).wait(2));

	// Layer 2
	this.instance_6 = new lib.Symbol1("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(-102,314);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).to({x:-28,y:311.5},29,cjs.Ease.get(1)).wait(62));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(219.8,302,857.2,338);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"_assets/images/bgNeutro.jpg?1620329989330", id:"bgNeutro"},
		{src:"_assets/images/man_body.png?1620329989330", id:"man_body"},
		{src:"_assets/images/man_boot.png?1620329989330", id:"man_boot"},
		{src:"_assets/images/man_eyebrow.png?1620329989330", id:"man_eyebrow"},
		{src:"_assets/images/man_hair.png?1620329989330", id:"man_hair"},
		{src:"_assets/images/man_hand.png?1620329989330", id:"man_hand"},
		{src:"_assets/images/man_head.png?1620329989330", id:"man_head"},
		{src:"_assets/images/man_pants.png?1620329989330", id:"man_pants"},
		{src:"_assets/images/maoEnvelope.jpg?1620329989330", id:"maoEnvelope"}
	],
	preloads: []
};
