...
p.nominalBounds = new cjs.Rectangle(0,0,1536,903);
...
(lib.s26 = function() {
	this.initialize(img.s26);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,400,262);


(lib.s27 = function() {
	this.initialize(img.s27);
}).prototype = p = new cjs.Bitmap();
...
(lib.wefdwefwefwef = function(mode,startPosition,loop) {
	...
	this.shape_3.graphics.f("rgba(0,0,0,0.2)").s().p("AhWCQIAAg5IA6AAIAAA5gAgcBWIAAg5IA5AAIAAA5gAAdAdIAAg5Ig5AAIAAg6Ig6AAIAAg5IA6AAIAAA5IA5AAIAAA6IA5AAIAAA5gAAdAdg");
...
(lib.Symbol8 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.text = new cjs.Text("E tem mais: não retenha informações\nconfidenciais/privilegiadas e nem as \nutilize em benefício próprio ou de terceiros. ", "19px 'EDP Preon'", "#FFFFFF");
	this.text.lineHeight = 29;
	this.text.lineWidth = 496;
	this.text.parent = this;
	this.text.setTransform(-206.5,-36.5);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.298)").s().p("EguwAOqIAAhIMBcAAAAIAA8LIBhAAIAAdTg");
	this.shape.setTransform(4.225,12.65);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(223,11,20,0.898)").s().p("EgtPAOrIhhAAIAA9VMBdhAAAIAABJIAAcMg");
	this.shape_1.setTransform(-5.525,5.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol8, new cjs.Rectangle(-304.8,-88.4,608.4000000000001,194.9), null);
...
(lib.Symbol7 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.s27();
	this.instance.parent = this;
	this.instance.setTransform(-512,-341.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol7, new cjs.Rectangle(-512,-341.5,1024,683), null);
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.text = new cjs.Text("Em caso de uma possível investigação, não será garantida devolução das informações pessoais armazenadas indevidamente no computador da EDP.\n\nE mesmo que não tenha a intenção de compartilhar informações confidenciais, cuidado com a transmissão de dados que possam causar danos à EDP ou à terceiros.", "19px 'EDP Preon'", "#333333");
	this.text.lineHeight = 29;
	this.text.lineWidth = 626;
	this.text.parent = this;
	this.text.setTransform(-312.85,-222.4);

	this.instance = new lib.s26();
	this.instance.parent = this;
	this.instance.setTransform(-180,-11.35,0.9,0.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance},{t:this.text}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol6, new cjs.Rectangle(-314.8,-224.4,629.7,448.9), null);
...
(lib.Symbol4 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-250,-166.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol4, new cjs.Rectangle(-250,-166.5,500,333), null);
...
(lib.Symbol3 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-512,-301,0.6667,0.6667);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol3, new cjs.Rectangle(-512,-301,1024,602), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-565,-318);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(-565,-318,1129,635), null);
...
(lib.__balaocopy8 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.caixaTexto = new cjs.Text("Minha função me dá acesso a base de clientes da EDP, mas tenho que ter consciência que não posso utilizar esses dados para outro fim que não sejam referentes à execução do meu trabalho.", "18px 'EDP Preon'", "#FFFFFF");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
	this.caixaTexto.lineWidth = 360;
	this.caixaTexto.parent = this;
	this.caixaTexto.setTransform(-17.45,-227.05);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#DF0B14").ss(3,1,1).p("AELCBIoVisIHWhV");
	this.shape.setTransform(17.942,-20.7686,0.9814,1.014,0,-74.8836,-61.9292);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#333333").s().p("AECB5IoUirIHWhVIBPEPg");
	this.shape_1.setTransform(19.0687,-21.3063,0.9814,1.014,0,-74.8836,-61.9292);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("AdSwDMg6jAAKQjIAAAADIIAAZtQAADIDIAAMA6jgAKQDIAAAAjIIAA5tQAAjIjIAAg");
	this.shape_2.setTransform(166.675,-142.15);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#333333").s().p("EggZAM7IAA5sQAAjIDIAAMA6jgAJQDIgBAADIIAAZtQAADIjIgBMg6jAAKQjIABAAjJg");
	this.shape_3.setTransform(166.675,-142.15);
...
}).prototype = getMCSymbolPrototype(lib.__balaocopy8, new cjs.Rectangle(-42.2,-246.4,417.8,249.1), null);
...
(lib.__balaocopy = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(395.075,-19.225);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F0F0F0").s().p("AiEiKIDSiAIFnAAIk5CEIowGRg");
	this.shape_1.setTransform(410.725,-25.65);

	this.caixaTexto = new cjs.Text("Sabia que toda a informação que circula ou é registrada\nnos sistemas informáticos disponibilizados pela EDP, \nsão de propriedade exclusiva da EDP? Olha só!", "18px 'EDP Preon'", "#333333");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
	this.caixaTexto.lineWidth = 594;
	this.caixaTexto.parent = this;
	this.caixaTexto.setTransform(30.05,-148.5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("EguAgKsMBcBAAKQDIAAAADIIAAO/QAADIjIAAMhcBgAKQjIAAAAjIIAAu/QAAjIDIAAg");
	this.shape_2.setTransform(311.725,-107.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F0F0F0").s().p("EguAAKjQjIAAAAjIIAAu/QAAjIDIAAMBcBAAKQDIAAAADIIAAO/QAADIjIAAg");
	this.shape_3.setTransform(311.725,-107.7);
...
}).prototype = getMCSymbolPrototype(lib.__balaocopy, new cjs.Rectangle(-4.3,-177.7,632.0999999999999,180.29999999999998), null);
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(137.35,58,0.8,0.8);

	this.text = new cjs.Text("Não utilize\ndocumentos ou\ndivulgue, sem\nautorização,\ninformações da EDP\npara uso pessoal ou \nde terceiros, mesmo que\no material tenha sido\nproduzido por você.", "19px 'EDP Preon'", "#333333");
	this.text.lineHeight = 29;
	this.text.lineWidth = 259;
	this.text.parent = this;
	this.text.setTransform(-335.3,-69.7);

	this.text_1 = new cjs.Text("Os recursos de informática são para\nutilização exclusivamente profissional.", "30px 'EDP Preon Hair'", "#DF0B14");
	this.text_1.lineHeight = 44;
	this.text_1.lineWidth = 668;
	this.text_1.parent = this;
	this.text_1.setTransform(-335.3,-189.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.text_1},{t:this.text},{t:this.instance}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol5, new cjs.Rectangle(-337.3,-191.2,674.7,382.4), null);
...
(lib.mouthcopy2 = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.instance = new lib.mouth_motioncopy2("synched",0);
	this.instance.parent = this;
...
// stage content:
(lib.edp_compliance24 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(52).call(this.frame_52).wait(1).call(this.frame_53).wait(33).call(this.frame_86).wait(1).call(this.frame_87).wait(12).call(this.frame_99).wait(1).call(this.frame_100).wait(28).call(this.frame_128).wait(1).call(this.frame_129).wait(11).call(this.frame_140).wait(1).call(this.frame_141).wait(31).call(this.frame_172).wait(1));

	// Layer_5
	this.instance = new lib.btnSeguir();
	this.instance.parent = this;
	this.instance.setTransform(864.3,151.95,0.8047,0.8047,0,0,0,25.6,27.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(52).to({_off:false},0).to({_off:true},1).wait(33).to({_off:false,x:851.85,y:478.65},0).to({_off:true},1).wait(12).to({_off:false,x:690.9,y:525.65},0).to({_off:true},1).wait(28).to({_off:false,x:572,y:122.6},0).to({_off:true},1).wait(11).to({_off:false,x:990.95,y:225.6},0).to({_off:true},1).wait(32));

	// Layer_6
	this.instance_1 = new lib.__balaocopy();
	this.instance_1.parent = this;
	this.instance_1.setTransform(512,301.6,1,1,0,0,0,276.1,110.4);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(39).to({_off:false},0).to({_off:true},14).wait(120));
	...
	var mask_graphics_142 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_143 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_144 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_145 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_146 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_147 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_148 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_149 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_150 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_151 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_152 = new cjs.Graphics().p("EicGA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_153 = new cjs.Graphics().p("EiW1A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_154 = new cjs.Graphics().p("EiREA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_155 = new cjs.Graphics().p("EiKyA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_156 = new cjs.Graphics().p("EiEBA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_157 = new cjs.Graphics().p("Eh83A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_158 = new cjs.Graphics().p("Eh2GA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_159 = new cjs.Graphics().p("Ehv0A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_160 = new cjs.Graphics().p("EhqDA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_161 = new cjs.Graphics().p("EhkyA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_162 = new cjs.Graphics().p("EhgAA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_163 = new cjs.Graphics().p("EhbvA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_164 = new cjs.Graphics().p("EhX/A9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_165 = new cjs.Graphics().p("EhUuA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_166 = new cjs.Graphics().p("EhR9A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_167 = new cjs.Graphics().p("EhPtA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_168 = new cjs.Graphics().p("EhN8A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_169 = new cjs.Graphics().p("EhMsA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_170 = new cjs.Graphics().p("EhL8A9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_171 = new cjs.Graphics().p("EhLsA9vMAy9h7dMEG1AAAMgy9B7dg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-977.975,y:313.1}).wait(1).to({graphics:mask_graphics_1,x:-889.4657,y:313.1}).wait(1).to({graphics:mask_graphics_2,x:-804.062,y:313.1}).wait(1).to({graphics:mask_graphics_3,x:-721.7639,y:313.1}).wait(1).to({graphics:mask_graphics_4,x:-642.5714,y:313.1}).wait(1).to({graphics:mask_graphics_5,x:-566.4845,y:313.1}).wait(1).to({graphics:mask_graphics_6,x:-493.5032,y:313.1}).wait(1).to({graphics:mask_graphics_7,x:-423.6274,y:313.1}).wait(1).to({graphics:mask_graphics_8,x:-356.8573,y:313.1}).wait(1).to({graphics:mask_graphics_9,x:-293.1927,y:313.1}).wait(1).to({graphics:mask_graphics_10,x:-232.6337,y:313.1}).wait(1).to({graphics:mask_graphics_11,x:-175.1804,y:313.1}).wait(1).to({graphics:mask_graphics_12,x:-120.8326,y:313.1}).wait(1).to({graphics:mask_graphics_13,x:-69.5903,y:313.1}).wait(1).to({graphics:mask_graphics_14,x:-21.4537,y:313.1}).wait(1).to({graphics:mask_graphics_15,x:23.5773,y:313.1}).wait(1).to({graphics:mask_graphics_16,x:65.5028,y:313.1}).wait(1).to({graphics:mask_graphics_17,x:104.3226,y:313.1}).wait(1).to({graphics:mask_graphics_18,x:140.0369,y:313.1}).wait(1).to({graphics:mask_graphics_19,x:172.6456,y:313.1}).wait(1).to({graphics:mask_graphics_20,x:202.1487,y:313.1}).wait(1).to({graphics:mask_graphics_21,x:228.5462,y:313.1}).wait(1).to({graphics:mask_graphics_22,x:251.8381,y:313.1}).wait(1).to({graphics:mask_graphics_23,x:272.0244,y:313.1}).wait(1).to({graphics:mask_graphics_24,x:289.1051,y:313.1}).wait(1).to({graphics:mask_graphics_25,x:303.0803,y:313.1}).wait(1).to({graphics:mask_graphics_26,x:313.9499,y:313.1}).wait(1).to({graphics:mask_graphics_27,x:321.7138,y:313.1}).wait(1).to({graphics:mask_graphics_28,x:326.3722,y:313.1}).wait(1).to({graphics:mask_graphics_29,x:327.925,y:313.1}).wait(1).to({graphics:null,x:0,y:0}).wait(112).to({graphics:mask_graphics_142,x:692.925,y:313.1}).wait(1).to({graphics:mask_graphics_143,x:696.1367,y:313.1}).wait(1).to({graphics:mask_graphics_144,x:705.7716,y:313.1}).wait(1).to({graphics:mask_graphics_145,x:721.8299,y:313.1}).wait(1).to({graphics:mask_graphics_146,x:744.3114,y:313.1}).wait(1).to({graphics:mask_graphics_147,x:773.2163,y:313.1}).wait(1).to({graphics:mask_graphics_148,x:808.5445,y:313.1}).wait(1).to({graphics:mask_graphics_149,x:850.296,y:313.1}).wait(1).to({graphics:mask_graphics_150,x:898.4708,y:313.1}).wait(1).to({graphics:mask_graphics_151,x:953.0689,y:313.1}).wait(1).to({graphics:mask_graphics_152,x:1009.1076,y:313.1}).wait(1).to({graphics:mask_graphics_153,x:1042.83,y:313.1}).wait(1).to({graphics:mask_graphics_154,x:1079.764,y:313.1}).wait(1).to({graphics:mask_graphics_155,x:1119.9097,y:313.1}).wait(1).to({graphics:mask_graphics_156,x:1163.267,y:313.1}).wait(1).to({graphics:mask_graphics_157,x:1209.033,y:313.1}).wait(1).to({graphics:mask_graphics_158,x:1252.3903,y:313.1}).wait(1).to({graphics:mask_graphics_159,x:1292.536,y:313.1}).wait(1).to({graphics:mask_graphics_160,x:1329.47,y:313.1}).wait(1).to({graphics:mask_graphics_161,x:1363.1924,y:313.1}).wait(1).to({graphics:mask_graphics_162,x:1393.7031,y:313.1}).wait(1).to({graphics:mask_graphics_163,x:1421.0021,y:313.1}).wait(1).to({graphics:mask_graphics_164,x:1445.0895,y:313.1}).wait(1).to({graphics:mask_graphics_165,x:1465.9652,y:313.1}).wait(1).to({graphics:mask_graphics_166,x:1483.6293,y:313.1}).wait(1).to({graphics:mask_graphics_167,x:1498.0818,y:313.1}).wait(1).to({graphics:mask_graphics_168,x:1509.3226,y:313.1}).wait(1).to({graphics:mask_graphics_169,x:1517.3517,y:313.1}).wait(1).to({graphics:mask_graphics_170,x:1522.1692,y:313.1}).wait(1).to({graphics:mask_graphics_171,x:1523.775,y:313.1}).wait(1).to({graphics:null,x:0,y:0}).wait(1));

	// Layer_14
	this.instance_2 = new lib.__balaocopy8("synched",0);
	this.instance_2.parent = this;
	this.instance_2.setTransform(626.55,267.85,1,1,0,0,0,9.8,-1.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(142).to({_off:false},0).to({x:743.55},29,cjs.Ease.quadInOut).to({_off:true},1).wait(1));

	// Layer_13
	this.instance_3 = new lib.__balaocopy8();
	this.instance_3.parent = this;
	this.instance_3.setTransform(626.55,267.85,1,1,0,0,0,9.8,-1.6);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(129).to({_off:false},0).to({_off:true},13).wait(31));

	// Layer_12
	this.instance_4 = new lib.Symbol8();
	this.instance_4.parent = this;
	this.instance_4.setTransform(247.85,-377.35);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(100).to({_off:false},0).to({y:113},18,cjs.Ease.quadInOut).wait(24).to({x:301.85},29,cjs.Ease.quadInOut).to({_off:true},1).wait(1));

	// Layer_11
	this.instance_5 = new lib.Symbol6();
	this.instance_5.parent = this;
	this.instance_5.setTransform(577,305.35);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(87).to({_off:false},0).to({x:512,alpha:1},11,cjs.Ease.quadInOut).wait(2).to({y:395.35,alpha:0.0117},18,cjs.Ease.quadInOut).to({_off:true},1).wait(54));

	// Layer_10
	this.instance_6 = new lib.Symbol5();
	this.instance_6.parent = this;
	this.instance_6.setTransform(565.5,287.45);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(73).to({_off:false},0).to({x:514.5,alpha:1},12,cjs.Ease.quadInOut).wait(2).to({x:448.5,alpha:0.0117},11,cjs.Ease.quadInOut).to({_off:true},1).wait(74));

	// Layer_9
	this.moca = new lib.showAvatarHolograma2();
	this.moca.name = "moca";
	this.moca.parent = this;
	this.moca.setTransform(513.65,149.9,0.6693,0.6693,0,0,180,0,0.1);
	this.moca._off = true;
	...
	this.timeline.addTween(cjs.Tween.get(this.moca).wait(33).to({_off:false},0).to({_off:true},20).wait(120));

	// Layer_8
	this.instance_7 = new lib.Symbol7();
	this.instance_7.parent = this;
	this.instance_7.setTransform(511.95,296.5,1.05,1.05);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(100).to({_off:false},0).to({y:341.5,alpha:1},18,cjs.Ease.quadInOut).wait(24).to({x:529.95},29,cjs.Ease.quadInOut).to({_off:true},1).wait(1));

	// Layer_7
	this.instance_8 = new lib.Symbol3();
	this.instance_8.parent = this;
	this.instance_8.setTransform(189,398);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).to({x:512,y:395},29,cjs.Ease.get(1)).wait(24).to({regX:0.1,regY:0.1,scaleX:1.464,scaleY:1.464,x:511.95,y:475.8},18,cjs.Ease.quadInOut).wait(29).to({y:545.8,alpha:0.0117},18,cjs.Ease.quadInOut).to({_off:true},1).wait(54));

	// Layer 2
	this.instance_9 = new lib.Symbol2();
	this.instance_9.parent = this;
	this.instance_9.setTransform(470.5,318);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).to({x:512.5,y:315},29,cjs.Ease.get(1)).wait(24).to({scaleX:1.1,scaleY:1.1,y:311.8},18,cjs.Ease.quadInOut).wait(29).to({y:331.8},18,cjs.Ease.quadInOut).to({_off:true},1).wait(54));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,-152.3,1261.4,1138.6);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"_assets/images/bgNeutro.jpg?1623070876888", id:"bgNeutro"},
		{src:"_assets/images/ipad.png?1623070876888", id:"ipad"},
		{src:"_assets/images/s25.jpg?1623070876888", id:"s25"},
		{src:"_assets/images/s26.jpg?1623070876888", id:"s26"},
		{src:"_assets/images/s27.jpg?1623070876888", id:"s27"},
		{src:"_assets/images/woman_body.png?1623070876888", id:"woman_body"},
		{src:"_assets/images/woman_hair.png?1623070876888", id:"woman_hair"},
		{src:"_assets/images/woman_hand.png?1623070876888", id:"woman_hand"},
		{src:"_assets/images/woman_head.png?1623070876888", id:"woman_head"},
		{src:"_assets/images/woman_pants.png?1623070876888", id:"woman_pants"}
	],
	preloads: []
};
