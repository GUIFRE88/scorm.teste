...
(lib.desafio9 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		...
		this.tentaMax = 2;
		this.respostas_correta = [true, true, false, false];
		
		
		this.mostrarCerta = function () {
			console.log('termina');
			_root.gotoAndStop('fim');
			for (var i = 0; i < btns.length; i++) {
				_desafio['v' + i].gotoAndStop(0);
				_desafio['f' + i].gotoAndStop(0);
				_desafio['v' + i].gotoAndStop(_desafio.respostas_correta[i]);
				if (_desafio.respostas_correta[i] == false) {
					_desafio['f' + i].gotoAndStop(1);
				}
			}
		...
		this.reset = function () {
			...
			for (var i = 0; i < btns.length; i++) {
				_desafio['v' + i].gotoAndStop(0);
				_desafio['f' + i].gotoAndStop(0);
				_desafio['v' + i].mouseEnabled = true;
				_desafio['f' + i].mouseEnabled = true;
			}
		}
		...
		this.verifica = function () {
			...
			for (var i = 0; i < _desafio.respostas_correta.length; i++) {
				_desafio['v' + i].mouseEnabled = false;
				_desafio['f' + i].mouseEnabled = false;
				if (_desafio['v' + i].currentFrame != _desafio.respostas_correta[i]) {
		...
		var btns = new Array;
		for (var i = 0; i < _desafio.respostas_correta.length; i++) {
			_desafio['v' + i].cursor = "pointer";
			_desafio['f' + i].cursor = "pointer";
			btns.push(i);
		}
		for (var i = 0; i < btns.length; i++) {
			(function (index) {
				_desafio['v' + btns[index]].addEventListener("click", function () {
					Player.stopAllAudio();
		
					_desafio['v' + index].gotoAndStop(1);
					_desafio['f' + index].gotoAndStop(0);
					if (_desafio.btnConferir.currentFrame < 1) {
						_desafio.btnConferir.gotoAndPlay(1);
					}
				})
				_desafio['f' + btns[index]].addEventListener("click", function () {
					Player.stopAllAudio();
		
					_desafio['f' + index].gotoAndStop(1);
					_desafio['v' + index].gotoAndStop(0);
					if (_desafio.btnConferir.currentFrame < 1) {
						_desafio.btnConferir.gotoAndPlay(1);
					}
				})
	...
	this.btnConferir.setTransform(45.6,257.6);

	this.timeline.addTween(cjs.Tween.get(this.btnConferir).wait(1));

	// Camada 1
	this.v3 = new lib.alter_V();
	this.v3.name = "v3";
	this.v3.parent = this;
	this.v3.setTransform(-434.2,197.4);

	this.f3 = new lib.alter_V();
	this.f3.name = "f3";
	this.f3.parent = this;
	this.f3.setTransform(-360.5,197.4);

	this.v2 = new lib.alter_V();
	this.v2.name = "v2";
	this.v2.parent = this;
	this.v2.setTransform(-434.2,111.7);

	this.f2 = new lib.alter_V();
	this.f2.name = "f2";
	this.f2.parent = this;
	this.f2.setTransform(-360.55,111.7);

	this.v1 = new lib.alter_V();
	this.v1.name = "v1";
	this.v1.parent = this;
	this.v1.setTransform(-434.2,26.1);

	this.f1 = new lib.alter_V();
	this.f1.name = "f1";
	this.f1.parent = this;
	this.f1.setTransform(-360.55,26.1);

	this.v0 = new lib.alter_V();
	this.v0.name = "v0";
	this.v0.parent = this;
	this.v0.setTransform(-434.2,-59.5);

	this.f0 = new lib.alter_V();
	this.f0.name = "f0";
	this.f0.parent = this;
	this.f0.setTransform(-360.55,-59.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.f0},{t:this.v0},{t:this.f1},{t:this.v1},{t:this.f2},{t:this.v2},{t:this.f3},{t:this.v3}]}).wait(1));

	// Camada 4
	this.text = new cjs.Text("F", "30px 'EDP Preon Hair'", "#DF0B14");
	this.text.textAlign = "center";
	this.text.lineHeight = 41;
	this.text.lineWidth = 57;
	this.text.parent = this;
	this.text.setTransform(-360.55,-143.85);

	this.text_1 = new cjs.Text("V", "30px 'EDP Preon Hair'", "#DF0B14");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 41;
	this.text_1.lineWidth = 57;
	this.text_1.parent = this;
	this.text_1.setTransform(-434.2,-143.85);

	this.text_2 = new cjs.Text("De acordo com o que apresentamos até aqui, analise as frases abaixo e indique se elas são verdadeiras ou falsas.", "30px 'EDP Preon Hair'", "#333333");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 41;
	this.text_2.lineWidth = 992;
	this.text_2.parent = this;
	this.text_2.setTransform(0,-258.25);

	this.text_3 = new cjs.Text("O comportamento dos colaboradores não é relevante. Desde que o trabalho seja feito, vale tudo.", "19px 'EDP Preon'", "#333333");
	this.text_3.lineHeight = 25;
	this.text_3.lineWidth = 752;
	this.text_3.parent = this;
	this.text_3.setTransform(-289.25,171.7);

	this.text_4 = new cjs.Text("Para utilizar o Canal de Ética é obrigatório se identificar.", "19px 'EDP Preon'", "#333333");
	this.text_4.lineHeight = 25;
	this.text_4.lineWidth = 752;
	this.text_4.parent = this;
	this.text_4.setTransform(-289.25,98.45);

	this.text_5 = new cjs.Text("Em relação a alguns temas, como corrupção, não basta deixar de praticá-los, mas também estar vigilante a eles e informar suspeitas.", "19px 'EDP Preon'", "#333333");
	this.text_5.lineHeight = 25;
	this.text_5.lineWidth = 752;
	this.text_5.parent = this;
	this.text_5.setTransform(-289.25,0.3);

	this.text_6 = new cjs.Text("A EDP possui um PROGRAMA DE COMPLIANCE para contribuir com a melhoria dos processos de gestão, cumprimento do Código de Ética, instrumentos normativos e legislações. ", "19px 'EDP Preon'", "#333333");
	this.text_6.lineHeight = 25;
	this.text_6.lineWidth = 752;
	this.text_6.parent = this;
	this.text_6.setTransform(-289.25,-97.85);
...
}).prototype = getMCSymbolPrototype(lib.desafio9, new cjs.Rectangle(-497.9,-260.2,995.9,577.3), null);


// stage content:
(lib.edp_compliance16 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{fim:48});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(30).call(this.frame_30).wait(8).call(this.frame_38).wait(42).call(this.frame_80).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(48).to({_off:false},0).to({_off:true},1).wait(32));
	...
	var mask_graphics_59 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_60 = new cjs.Graphics().p("EicGA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_61 = new cjs.Graphics().p("EiW1A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_62 = new cjs.Graphics().p("EiREA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_63 = new cjs.Graphics().p("EiKyA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_64 = new cjs.Graphics().p("EiEBA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_65 = new cjs.Graphics().p("Eh83A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_66 = new cjs.Graphics().p("Eh2GA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_67 = new cjs.Graphics().p("Ehv0A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_68 = new cjs.Graphics().p("EhqDA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_69 = new cjs.Graphics().p("EhkyA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_70 = new cjs.Graphics().p("EhgAA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_71 = new cjs.Graphics().p("EhbvA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_72 = new cjs.Graphics().p("EhX/A9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_73 = new cjs.Graphics().p("EhUuA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_74 = new cjs.Graphics().p("EhR9A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_75 = new cjs.Graphics().p("EhPtA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_76 = new cjs.Graphics().p("EhN8A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_77 = new cjs.Graphics().p("EhMsA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_78 = new cjs.Graphics().p("EhL8A9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_79 = new cjs.Graphics().p("EhLsA9vMAy9h7dMEG1AAAMgy9B7dg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-977.975,y:313.1}).wait(1).to({graphics:mask_graphics_1,x:-889.4657,y:313.1}).wait(1).to({graphics:mask_graphics_2,x:-804.062,y:313.1}).wait(1).to({graphics:mask_graphics_3,x:-721.7639,y:313.1}).wait(1).to({graphics:mask_graphics_4,x:-642.5714,y:313.1}).wait(1).to({graphics:mask_graphics_5,x:-566.4845,y:313.1}).wait(1).to({graphics:mask_graphics_6,x:-493.5032,y:313.1}).wait(1).to({graphics:mask_graphics_7,x:-423.6274,y:313.1}).wait(1).to({graphics:mask_graphics_8,x:-356.8573,y:313.1}).wait(1).to({graphics:mask_graphics_9,x:-293.1927,y:313.1}).wait(1).to({graphics:mask_graphics_10,x:-232.6337,y:313.1}).wait(1).to({graphics:mask_graphics_11,x:-175.1804,y:313.1}).wait(1).to({graphics:mask_graphics_12,x:-120.8326,y:313.1}).wait(1).to({graphics:mask_graphics_13,x:-69.5903,y:313.1}).wait(1).to({graphics:mask_graphics_14,x:-21.4537,y:313.1}).wait(1).to({graphics:mask_graphics_15,x:23.5773,y:313.1}).wait(1).to({graphics:mask_graphics_16,x:65.5028,y:313.1}).wait(1).to({graphics:mask_graphics_17,x:104.3226,y:313.1}).wait(1).to({graphics:mask_graphics_18,x:140.0369,y:313.1}).wait(1).to({graphics:mask_graphics_19,x:172.6456,y:313.1}).wait(1).to({graphics:mask_graphics_20,x:202.1487,y:313.1}).wait(1).to({graphics:mask_graphics_21,x:228.5462,y:313.1}).wait(1).to({graphics:mask_graphics_22,x:251.8381,y:313.1}).wait(1).to({graphics:mask_graphics_23,x:272.0244,y:313.1}).wait(1).to({graphics:mask_graphics_24,x:289.1051,y:313.1}).wait(1).to({graphics:mask_graphics_25,x:303.0803,y:313.1}).wait(1).to({graphics:mask_graphics_26,x:313.9499,y:313.1}).wait(1).to({graphics:mask_graphics_27,x:321.7138,y:313.1}).wait(1).to({graphics:mask_graphics_28,x:326.3722,y:313.1}).wait(1).to({graphics:mask_graphics_29,x:327.925,y:313.1}).wait(1).to({graphics:null,x:0,y:0}).wait(20).to({graphics:mask_graphics_50,x:692.925,y:313.1}).wait(1).to({graphics:mask_graphics_51,x:696.1367,y:313.1}).wait(1).to({graphics:mask_graphics_52,x:705.7716,y:313.1}).wait(1).to({graphics:mask_graphics_53,x:721.8299,y:313.1}).wait(1).to({graphics:mask_graphics_54,x:744.3114,y:313.1}).wait(1).to({graphics:mask_graphics_55,x:773.2163,y:313.1}).wait(1).to({graphics:mask_graphics_56,x:808.5445,y:313.1}).wait(1).to({graphics:mask_graphics_57,x:850.296,y:313.1}).wait(1).to({graphics:mask_graphics_58,x:898.4708,y:313.1}).wait(1).to({graphics:mask_graphics_59,x:953.0689,y:313.1}).wait(1).to({graphics:mask_graphics_60,x:1009.1076,y:313.1}).wait(1).to({graphics:mask_graphics_61,x:1042.83,y:313.1}).wait(1).to({graphics:mask_graphics_62,x:1079.764,y:313.1}).wait(1).to({graphics:mask_graphics_63,x:1119.9097,y:313.1}).wait(1).to({graphics:mask_graphics_64,x:1163.267,y:313.1}).wait(1).to({graphics:mask_graphics_65,x:1209.033,y:313.1}).wait(1).to({graphics:mask_graphics_66,x:1252.3903,y:313.1}).wait(1).to({graphics:mask_graphics_67,x:1292.536,y:313.1}).wait(1).to({graphics:mask_graphics_68,x:1329.47,y:313.1}).wait(1).to({graphics:mask_graphics_69,x:1363.1924,y:313.1}).wait(1).to({graphics:mask_graphics_70,x:1393.7031,y:313.1}).wait(1).to({graphics:mask_graphics_71,x:1421.0021,y:313.1}).wait(1).to({graphics:mask_graphics_72,x:1445.0895,y:313.1}).wait(1).to({graphics:mask_graphics_73,x:1465.9652,y:313.1}).wait(1).to({graphics:mask_graphics_74,x:1483.6293,y:313.1}).wait(1).to({graphics:mask_graphics_75,x:1498.0818,y:313.1}).wait(1).to({graphics:mask_graphics_76,x:1509.3226,y:313.1}).wait(1).to({graphics:mask_graphics_77,x:1517.3517,y:313.1}).wait(1).to({graphics:mask_graphics_78,x:1522.1692,y:313.1}).wait(1).to({graphics:mask_graphics_79,x:1523.775,y:313.1}).wait(1).to({graphics:null,x:0,y:0}).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(30).to({_off:false},0).to({_off:true},50).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({x:-28,y:311.5},29,cjs.Ease.get(1)).to({_off:true},51).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"_assets/images/bgNeutro.jpg?1620331042904", id:"bgNeutro"}
	],
	preloads: []
};
