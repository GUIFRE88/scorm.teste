...
(lib.__balaocopy7 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.caixaTexto = new cjs.Text("E agora vamos testar o que aprendemos até aqui?", "18px 'EDP Preon'", "#333333");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
	this.caixaTexto.lineWidth = 284;
	this.caixaTexto.parent = this;
	this.caixaTexto.setTransform(35.5,-86.7);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("A2BnGMAsDAAKQDIAAAADIIAAHzQAADIjIAAMgsDgAKQjIAAAAjIIAAnzQAAjIDIAAg");
	this.shape_2.setTransform(177.425,-60.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F0F0F0").s().p("A2BG9QjIAAAAjIIAAnzQAAjIDIAAMAsDAAKQDIAAAADIIAAHzQAADIjIAAg");
	this.shape_3.setTransform(177.425,-60.5);
...
}).prototype = getMCSymbolPrototype(lib.__balaocopy7, new cjs.Rectangle(14.9,-107.5,325.1,132.4), null);
...
(lib.__balaocopy = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.caixaTexto = new cjs.Text("Estamos encerrando este treinamento. É fundamental colocar em prática todos os pontos apresentados aqui, bem como observar sempre se estes compromissos vêm sendo cumpridos de maneira correta.", "18px 'EDP Preon'", "#333333");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
	this.caixaTexto.lineWidth = 567;
	this.caixaTexto.parent = this;
	this.caixaTexto.setTransform(-125.85,-141.4);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("Egr5gLZMBXzAAKQDIAAAADIIAAQZQAADIjIAAMhXzgAKQjIAAAAjIIAAwZQAAjIDIAAg");
	this.shape_2.setTransform(157.425,-88);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F0F0F0").s().p("Egr5ALQQjIAAAAjIIAAwZQAAjIDIAAMBXzAAKQDIAAAADIIAAQZQAADIjIAAg");
	this.shape_3.setTransform(157.425,-88);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape},{t:this.caixaTexto}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.__balaocopy, new cjs.Rectangle(-145.1,-162.5,605.1,187.4), null);
...
// stage content:
(lib.edp_compliance33 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(44).call(this.frame_44).wait(1).call(this.frame_45).wait(17).call(this.frame_62).wait(1).call(this.frame_63).wait(32).call(this.frame_95).wait(1));

	// Layer_5
	this.instance = new lib.btnSeguir();
	this.instance.parent = this;
	this.instance.setTransform(753.1,164.65,0.8047,0.8047,0,0,0,25.6,27.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(44).to({_off:false},0).to({_off:true},1).wait(17).to({_off:false,x:633.1,y:160.65},0).to({_off:true},1).wait(33));
	...
	this.instance_2 = new lib.__balaocopy7();
	this.instance_2.parent = this;
	this.instance_2.setTransform(363.45,206.2,1,1,0,0,0,68.4,29.4);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},31).to({state:[]},14).to({state:[{t:this.instance_2}]},4).to({state:[]},14).wait(33));
	...
	var mask_graphics_65 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_66 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_67 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_68 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_69 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_70 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_71 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_72 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_73 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_74 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_75 = new cjs.Graphics().p("EicGA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_76 = new cjs.Graphics().p("EiW1A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_77 = new cjs.Graphics().p("EiREA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_78 = new cjs.Graphics().p("EiKyA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_79 = new cjs.Graphics().p("EiEBA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_80 = new cjs.Graphics().p("Eh83A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_81 = new cjs.Graphics().p("Eh2GA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_82 = new cjs.Graphics().p("Ehv0A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_83 = new cjs.Graphics().p("EhqDA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_84 = new cjs.Graphics().p("EhkyA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_85 = new cjs.Graphics().p("EhgAA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_86 = new cjs.Graphics().p("EhbvA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_87 = new cjs.Graphics().p("EhX/A9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_88 = new cjs.Graphics().p("EhUuA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_89 = new cjs.Graphics().p("EhR9A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_90 = new cjs.Graphics().p("EhPtA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_91 = new cjs.Graphics().p("EhN8A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_92 = new cjs.Graphics().p("EhMsA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_93 = new cjs.Graphics().p("EhL8A9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_94 = new cjs.Graphics().p("EhLsA9vMAy9h7dMEG1AAAMgy9B7dg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-977.975,y:313.1}).wait(1).to({graphics:mask_graphics_1,x:-889.4657,y:313.1}).wait(1).to({graphics:mask_graphics_2,x:-804.062,y:313.1}).wait(1).to({graphics:mask_graphics_3,x:-721.7639,y:313.1}).wait(1).to({graphics:mask_graphics_4,x:-642.5714,y:313.1}).wait(1).to({graphics:mask_graphics_5,x:-566.4845,y:313.1}).wait(1).to({graphics:mask_graphics_6,x:-493.5032,y:313.1}).wait(1).to({graphics:mask_graphics_7,x:-423.6274,y:313.1}).wait(1).to({graphics:mask_graphics_8,x:-356.8573,y:313.1}).wait(1).to({graphics:mask_graphics_9,x:-293.1927,y:313.1}).wait(1).to({graphics:mask_graphics_10,x:-232.6337,y:313.1}).wait(1).to({graphics:mask_graphics_11,x:-175.1804,y:313.1}).wait(1).to({graphics:mask_graphics_12,x:-120.8326,y:313.1}).wait(1).to({graphics:mask_graphics_13,x:-69.5903,y:313.1}).wait(1).to({graphics:mask_graphics_14,x:-21.4537,y:313.1}).wait(1).to({graphics:mask_graphics_15,x:23.5773,y:313.1}).wait(1).to({graphics:mask_graphics_16,x:65.5028,y:313.1}).wait(1).to({graphics:mask_graphics_17,x:104.3226,y:313.1}).wait(1).to({graphics:mask_graphics_18,x:140.0369,y:313.1}).wait(1).to({graphics:mask_graphics_19,x:172.6456,y:313.1}).wait(1).to({graphics:mask_graphics_20,x:202.1487,y:313.1}).wait(1).to({graphics:mask_graphics_21,x:228.5462,y:313.1}).wait(1).to({graphics:mask_graphics_22,x:251.8381,y:313.1}).wait(1).to({graphics:mask_graphics_23,x:272.0244,y:313.1}).wait(1).to({graphics:mask_graphics_24,x:289.1051,y:313.1}).wait(1).to({graphics:mask_graphics_25,x:303.0803,y:313.1}).wait(1).to({graphics:mask_graphics_26,x:313.9499,y:313.1}).wait(1).to({graphics:mask_graphics_27,x:321.7138,y:313.1}).wait(1).to({graphics:mask_graphics_28,x:326.3722,y:313.1}).wait(1).to({graphics:mask_graphics_29,x:327.925,y:313.1}).wait(1).to({graphics:null,x:0,y:0}).wait(35).to({graphics:mask_graphics_65,x:692.925,y:313.1}).wait(1).to({graphics:mask_graphics_66,x:696.1367,y:313.1}).wait(1).to({graphics:mask_graphics_67,x:705.7716,y:313.1}).wait(1).to({graphics:mask_graphics_68,x:721.8299,y:313.1}).wait(1).to({graphics:mask_graphics_69,x:744.3114,y:313.1}).wait(1).to({graphics:mask_graphics_70,x:773.2163,y:313.1}).wait(1).to({graphics:mask_graphics_71,x:808.5445,y:313.1}).wait(1).to({graphics:mask_graphics_72,x:850.296,y:313.1}).wait(1).to({graphics:mask_graphics_73,x:898.4708,y:313.1}).wait(1).to({graphics:mask_graphics_74,x:953.0689,y:313.1}).wait(1).to({graphics:mask_graphics_75,x:1009.1076,y:313.1}).wait(1).to({graphics:mask_graphics_76,x:1042.83,y:313.1}).wait(1).to({graphics:mask_graphics_77,x:1079.764,y:313.1}).wait(1).to({graphics:mask_graphics_78,x:1119.9097,y:313.1}).wait(1).to({graphics:mask_graphics_79,x:1163.267,y:313.1}).wait(1).to({graphics:mask_graphics_80,x:1209.033,y:313.1}).wait(1).to({graphics:mask_graphics_81,x:1252.3903,y:313.1}).wait(1).to({graphics:mask_graphics_82,x:1292.536,y:313.1}).wait(1).to({graphics:mask_graphics_83,x:1329.47,y:313.1}).wait(1).to({graphics:mask_graphics_84,x:1363.1924,y:313.1}).wait(1).to({graphics:mask_graphics_85,x:1393.7031,y:313.1}).wait(1).to({graphics:mask_graphics_86,x:1421.0021,y:313.1}).wait(1).to({graphics:mask_graphics_87,x:1445.0895,y:313.1}).wait(1).to({graphics:mask_graphics_88,x:1465.9652,y:313.1}).wait(1).to({graphics:mask_graphics_89,x:1483.6293,y:313.1}).wait(1).to({graphics:mask_graphics_90,x:1498.0818,y:313.1}).wait(1).to({graphics:mask_graphics_91,x:1509.3226,y:313.1}).wait(1).to({graphics:mask_graphics_92,x:1517.3517,y:313.1}).wait(1).to({graphics:mask_graphics_93,x:1522.1692,y:313.1}).wait(1).to({graphics:mask_graphics_94,x:1523.775,y:313.1}).wait(1).to({graphics:null,x:0,y:0}).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.moco).to({x:370.4},29,cjs.Ease.quadInOut).wait(36).to({x:500.4},29,cjs.Ease.quadInOut).to({_off:true},1).wait(1));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({x:-28,y:311.5},29,cjs.Ease.get(1)).wait(36).to({startPosition:0},0).to({x:2},29,cjs.Ease.quadInOut).to({_off:true},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,1107,635);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"_assets/images/bgNeutro.jpg?1620329858985", id:"bgNeutro"},
		{src:"_assets/images/man_body.png?1620329858985", id:"man_body"},
		{src:"_assets/images/man_boot.png?1620329858985", id:"man_boot"},
		{src:"_assets/images/man_eyebrow.png?1620329858985", id:"man_eyebrow"},
		{src:"_assets/images/man_hair.png?1620329858985", id:"man_hair"},
		{src:"_assets/images/man_hand.png?1620329858985", id:"man_hand"},
		{src:"_assets/images/man_head.png?1620329858985", id:"man_head"},
		{src:"_assets/images/man_pants.png?1620329858985", id:"man_pants"},
		{src:"_assets/images/woman_body.png?1620329858985", id:"woman_body"},
		{src:"_assets/images/woman_hair.png?1620329858985", id:"woman_hair"},
		{src:"_assets/images/woman_hand.png?1620329858985", id:"woman_hand"},
		{src:"_assets/images/woman_head.png?1620329858985", id:"woman_head"},
		{src:"_assets/images/woman_pants.png?1620329858985", id:"woman_pants"}
	],
	preloads: []
};
