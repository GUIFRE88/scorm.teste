...
(lib.shieldCheck_1 = function() {
	this.initialize(img.shieldCheck_1);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,44,52);
...
(lib.Symbol81 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.text = new cjs.Text("Tem origem no verbo “to comply” que significa cumprir, satisfazer, aderir, estar em conformidade ou de acordo com algo.", "18px 'EDP Preon'", "#FFFFFF");
	this.text.lineHeight = 27;
	this.text.lineWidth = 367;
	this.text.parent = this;
	this.text.setTransform(-291.3,-14.5);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.298)").s().p("EglnAL0IAAhJMBJuAAAIAA2eIBhAAIAAXng");
	this.shape.setTransform(-63.475,46.15);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(223,11,20,0.898)").s().p("EgkGAL0IhhAAIAA3nMBLPAAAIAABJIAAWeg");
	this.shape_1.setTransform(-73.225,38.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-314,-36.7,491.4,158.5);
...
(lib.Symbol9 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.joia();
	this.instance.parent = this;
	this.instance.setTransform(-16.5,-20);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol9, new cjs.Rectangle(-16.5,-20,33,40), null);
...
(lib.Symbol6 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-542,-349,1.02,1.02);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol6, new cjs.Rectangle(-542,-349,1044.5,696.7), null);
...
(lib.Symbol5 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.shieldCheck_1();
	this.instance.parent = this;
	this.instance.setTransform(-22,-26);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol5, new cjs.Rectangle(-22,-26,44,52), null);
...
(lib.__balaocopy6 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.text = new cjs.Text("Compliance?", "bold 18px 'EDP Preon Thin'", "#333333");
	this.text.lineHeight = 25;
	this.text.lineWidth = 182;
	this.text.parent = this;
	this.text.setTransform(80.8,-14.35);

	this.text_1 = new cjs.Text("Para começarmos,\nvocê sabe o que\nsignifica a palavra", "18px 'EDP Preon'", "#333333");
	this.text_1.lineHeight = 25;
	this.text_1.lineWidth = 203;
	this.text_1.parent = this;
	this.text_1.setTransform(80.8,-95.95);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#DF0B14").ss(3,1,1).p("AELCAIoViqIHWhV");
	this.shape.setTransform(31.575,4.25);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F0F0F0").s().p("ACiAlIoUirIHWhVICyBWIBdFhg");
	this.shape_1.setTransform(42.025,13.375);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("Avis4IfFAKQDIAAAADIIAATXQAADIjIAAI/FgKQjIAAAAjIIAAzXQAAjIDIAAg");
	this.shape_2.setTransform(171.925,-42.55);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F0F0F0").s().p("AviMvQjIAAAAjIIAAzXQAAjIDIAAIfFAKQDIAAAADIIAATXQAADIjIAAg");
	this.shape_3.setTransform(171.925,-42.55);
...
}).prototype = getMCSymbolPrototype(lib.__balaocopy6, new cjs.Rectangle(3.4,-126.5,289.6,168), null);


(lib.__balaocopy5 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Layer_1
	this.caixaTexto = new cjs.Text("Desejamos a\nvocê um bom\ntreinamento. ", "18px 'EDP Preon'", "#333333");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
	this.caixaTexto.lineWidth = 153;
	this.caixaTexto.parent = this;
	this.caixaTexto.setTransform(-155.15,-140.8);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("ALap1I2zAKQjIAAAADIIAANRQAADIDIAAIWzgKQDIAAAAjIIAAtRQAAjIjIAAg");
	this.shape_2.setTransform(-88.575,-101);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F0F0F0").s().p("AuhGuIAAtRQAAjIDIAAIWzgKQDIAAAADIIAANRQAADIjIAAI2zAKQjIAAAAjIg");
	this.shape_3.setTransform(-88.575,-101);
...
}).prototype = getMCSymbolPrototype(lib.__balaocopy5, new cjs.Rectangle(-183.1,-165.5,189.1,167.4), null);


(lib.__balaocopy3 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.caixaTexto = new cjs.Text("É isso mesmo! É importante que você, Parceiro EDP, conheça e aplique esses princípios na sua rotina de trabalho.", "18px 'EDP Preon'", "#333333");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
	this.caixaTexto.lineWidth = 193;
	this.caixaTexto.parent = this;
	this.caixaTexto.setTransform(81.15,-157.25);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("AwZzNMAgzAAKQDIAAAADIMAAAAgBQAADIjIAAMggzgAKQjIAAAAjIMAAAggBQAAjIDIAAg");
	this.shape_2.setTransform(177.425,-63.05);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F0F0F0").s().p("AwZTEQjIAAAAjIMAAAggBQAAjIDIAAMAgzAAKQDIAAAADIMAAAAgBQAADIjIAAg");
	this.shape_3.setTransform(177.425,-63.05);
...
}).prototype = getMCSymbolPrototype(lib.__balaocopy3, new cjs.Rectangle(3.4,-187.5,300.6,249), null);
...
(lib.__balaocopy2 = function(mode,startPosition,loop) {
	...
	this.caixaTexto = new cjs.Text("E eu sou a Pilar. Estamos aqui para falar sobre os Princípios Éticos adotados pela EDP e do comportamento esperado de todos os terceiros que atuam em nosso nome. ", "18px 'EDP Preon'", "#333333");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
...
(lib.__balaocopy = function(mode,startPosition,loop) {
	...
	this.caixaTexto = new cjs.Text("Olá, eu sou o Convincente. \nSeja bem-vindo(a) a este\ntreinamento!", "18px 'EDP Preon'", "#333333");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
	this.caixaTexto.lineWidth = 288;
	this.caixaTexto.parent = this;
	this.caixaTexto.setTransform(55.45,-116.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("A1Pp1MAqfAAKQDIAAAADIIAANRQAADIjIAAMgqfgAKQjIAAAAjIIAAtRQAAjIDIAAg");
	this.shape_2.setTransform(192.425,-78);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F0F0F0").s().p("A1PJsQjIAAAAjIIAAtRQAAjIDIAAMAqfAAKQDIAAAADIIAANRQAADIjIAAg");
	this.shape_3.setTransform(192.425,-78);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.caixaTexto},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.__balaocopy, new cjs.Rectangle(34.9,-142.5,315.1,167.4), null);
...
(lib.Symbol81copy = function(mode,startPosition,loop) {
	...
	this.text = new cjs.Text("COMPLIANCE... ", "25px 'EDP Preon Hair'", "#FFFFFF");
	this.text.lineHeight = 37;
	this.text.lineWidth = 367;
	this.text.parent = this;
	this.text.setTransform(-291.3,-11.75);

	this.text_1 = new cjs.Text("É a atividade de assegurar que as\nnormas, regulamentos e as\ndiretrizes da empresa estão sendo\ncumpridas, bem como estabelecer\npráticas para evitar, detectar e\ntratar qualquer desvio ou\ninconformidade que possa ocorrer.", "18px 'EDP Preon'", "#FFFFFF");
	this.text_1.lineHeight = 27;
	this.text_1.lineWidth = 401;
	this.text_1.parent = this;
	this.text_1.setTransform(-291.3,41.95);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(51,51,51,0.898)").s().p("EgkGAW1IhhAAMAAAgtpMBLPAAAIAABJMAAAAsgg");
	this.shape.setTransform(-73.225,109.4);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.298)").s().p("EglnAW1IAAhIMBJuAAAMAAAgshIBhAAMAAAAtpg");
	this.shape_1.setTransform(-63.475,116.65);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text_1},{t:this.text},{t:this.instance}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-314,-36.7,491.4,299.5);
...
(lib.Symbol10 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(-33,-12.8,1,1,0,0,0,-33,-12.8);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({rotation:14.9992,x:-33.05,y:-12.85},9,cjs.Ease.quadInOut).to({rotation:-14.9992,y:-12.8},9,cjs.Ease.quadInOut).to({rotation:8.0002,x:-33},9,cjs.Ease.quadInOut).to({rotation:0},9,cjs.Ease.quadInOut).wait(10));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-25.6,-32.5,48.900000000000006,64.1);
...
(lib.Symbol7 = function(mode,startPosition,loop) {
	...
	this.frame_0 = function() {
		function abrePDF() {
			window.open("_assets/extra/edp_compliance02.pdf", "blank");
		}
		this.addEventListener('click', abrePDF.bind(this));
		this.cursor = "pointer";
	}
	...
	// Layer_2
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(255,255,255,0.008)").s().p("A8CDIQgGAAgEgFQgFgEAAgGIAAlxQAAgGAFgEQAEgFAGAAMA4FAAAQAGAAAEAFQAFAEAAAGIAAFxQAAAGgFAEQgEAFgGAAg");
	...
	mask._off = true;
	mask.graphics.p("A8UDIQgGAAgEgFQgFgEAAgGIAAlxQAAgGAFgEQAEgFAGAAMA4pAAAQAGAAAEAFQAFAEAAAGIAAFxQAAAGgFAEQgEAFgGAAgA8FCqMA4LAAAIAAlTMg4LAAAg");
	mask.setTransform(-1.8,-1.975);

	// Layer_3
	this.instance = new lib.Symbol8();
	this.instance.parent = this;
	this.instance.setTransform(-228.45,-0.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:222.05},42,cjs.Ease.quadInOut).to({x:-228.45},42,cjs.Ease.quadInOut).wait(1));

	// Layer_4
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("rgba(255,255,255,0.498)").ss(2,1,1).p("AcGipIAAFTMg4LAAAIAAlTg");
	this.shape_1.setTransform(-1.8,-1.975);

	this.timeline.addTween(cjs.Tween.get(this.shape_1).wait(85));

	// Layer_5
	this.text = new cjs.Text("Clique aqui para baixar uma cópia.", "bold 18px 'EDP Preon Thin'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 27;
	this.text.lineWidth = 499;
	this.text.parent = this;
	this.text.setTransform(0,-11.6);

	this.timeline.addTween(cjs.Tween.get(this.text).wait(85));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-251.5,-21.9,503.1,39.9);
...
(lib.Symbol1copy2 = function(mode,startPosition,loop) {
	...
	this.botao.setTransform(162.5,34.5);

	this.timeline.addTween(cjs.Tween.get(this.botao).wait(1));

	// Layer_4
	this.instance = new lib.Symbol10();
	this.instance.parent = this;
	this.instance.setTransform(442.05,-23.3,1.2075,1.2075,0,0,0,-8.2,-0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_1
	this.text = new cjs.Text("E a EDP possui um PROGRAMA DE COMPLIANCE para contribuir com a melhoria dos processos de gestão, cumprimento do Código de Ética, instrumentos normativos e legislações. ", "18px 'EDP Preon Hair'", "#FFFFFF");
	this.text.lineHeight = 27;
	this.text.lineWidth = 501;
	this.text.parent = this;
	this.text.setTransform(-13.15,-113.5);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(0,0,0,0.898)").s().p("EgoeAQ/QjEAAgEjAIAA71QAAjIDIAAMBQ9AAAQDIAAAADIIAAb1QgDDAjFAAg");
	this.shape.setTransform(237.175,-32.925);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("rgba(0,0,0,0.298)").s().p("EgoeAB+QjIAAAAjHIAAg0QAEC/DEAAMBQ9AAAQDFAAADi/IAAA0QAADHjIAAg");
	this.shape_1.setTransform(237.175,69.175);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text}]}).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-117.2,-141.6,633.5,223.39999999999998);
...
(lib.man = function(mode,startPosition,loop) {
	...
	this.cab = new lib.face();
	this.cab.name = "cab";
	this.cab.parent = this;
	this.cab.setTransform(114.6,137.4,1,1,0,0,0,72.2,81.2);
	this.cab._off = true;

	this.timeline.addTween(cjs.Tween.get(this.kbeca).to({_off:true,y:137.4},19,cjs.Ease.get(1)).wait(281));
	this.timeline.addTween(cjs.Tween.get(this.cab).to({_off:false},19,cjs.Ease.get(1)).to({y:140.2},20,cjs.Ease.get(1)).to({y:137.4},20,cjs.Ease.get(1)).to({y:140.2},20,cjs.Ease.get(1)).to({y:137.4},20,cjs.Ease.get(1)).to({y:140.2},20,cjs.Ease.get(1)).to({regX:72.3,rotation:4.9756,x:126.85,y:140.45},10,cjs.Ease.get(1)).to({regX:72.2,rotation:0,x:114.6,y:140.2},6,cjs.Ease.get(-1)).to({rotation:-3.9917,x:107.95,y:133.35},6,cjs.Ease.get(1)).to({rotation:0,x:114.6,y:140.2},9,cjs.Ease.get(-1)).wait(1).to({y:137.4},19,cjs.Ease.get(1)).to({y:140.2},20,cjs.Ease.get(1)).to({y:137.4},20,cjs.Ease.get(1)).to({y:140.2},20,cjs.Ease.get(1)).to({y:137.4},20,cjs.Ease.get(1)).to({y:140.2},20,cjs.Ease.get(1)).to({regX:72.3,regY:81.4,rotation:-3.2277,x:106.9,y:138.3},9,cjs.Ease.get(1)).to({regX:72.2,regY:81.2,rotation:0,x:114.6,y:140.2},5,cjs.Ease.get(-1)).to({regX:72.5,regY:81.3,rotation:3.9539,x:119.95,y:131.85},6,cjs.Ease.get(1)).to({regX:72.2,regY:81.2,rotation:0,x:114.6,y:140.2},9,cjs.Ease.get(1)).wait(1));
...
// stage content:
(lib.edp_compliance02 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_44 = function() {
		console.log(_root.homem.corpo.currentFrame)
		Player.setPlayAudio({
		   file:"comp_02a.mp3", 
		   onStart:function(){ 
		      _root.stop();	
			   console.log(_root.homem.corpo.currentFrame)
			   _root.homem.corpo.cab.boca.gotoAndStop(1);
			   console.log(_root.homem.corpo.currentFrame)
		   },
		   onComplete:function(){ // ao terminar
		     // _root.play();
			   _root.homem.corpo.cab.boca.gotoAndStop(0);
		   }
		});
	}
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(44).call(this.frame_44).wait(1).call(this.frame_45).wait(13).call(this.frame_58).wait(1).call(this.frame_59).wait(35).call(this.frame_94).wait(1).call(this.frame_95).wait(14).call(this.frame_109).wait(1).call(this.frame_110).wait(43).call(this.frame_153).wait(1).call(this.frame_154).wait(37).call(this.frame_191).wait(1).call(this.frame_192).wait(3).call(this.frame_195).wait(1).call(this.frame_196).wait(51).call(this.frame_247).wait(1).call(this.frame_248).wait(33).call(this.frame_281).wait(1));

	// Layer_5
	this.instance = new lib.btnSeguir();
	this.instance.parent = this;
	this.instance.setTransform(622.1,180.65,0.8047,0.8047,0,0,0,25.6,27.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(44).to({_off:false},0).to({_off:true},1).wait(13).to({_off:false,x:809,y:61.8},0).to({_off:true},1).wait(35).to({_off:false,x:622.5,y:416.75},0).to({_off:true},1).wait(14).to({_off:false,x:653.4,y:221.8},0).to({_off:true},1).wait(43).to({_off:false,x:714.5,y:382.75},0).to({_off:true},1).wait(37).to({_off:false,x:985.25,y:528},0).to({_off:true},1).wait(3).to({_off:false},0).to({_off:true},1).wait(51).to({_off:false,x:791.3,y:472.2},0).to({_off:true},1).wait(34));

	// Layer_6
	this.instance_1 = new lib.__balaocopy();
	this.instance_1.parent = this;
	this.instance_1.setTransform(349.45,230.2,1,1,0,0,0,68.4,29.4);

	this.instance_2 = new lib.__balaocopy2();
	this.instance_2.parent = this;
	this.instance_2.setTransform(742.95,275.2,1,1,0,0,0,68.4,29.4);

	this.instance_3 = new lib.__balaocopy3();
	this.instance_3.parent = this;
	this.instance_3.setTransform(215.45,355.2,1,1,0,0,0,-104.6,-1.6);

	this.instance_4 = new lib.__balaocopy5();
	this.instance_4.parent = this;
	this.instance_4.setTransform(816.85,357.15,1,1,0,0,0,172.3,91.2);

	this.instance_5 = new lib.__balaocopy6();
	this.instance_5.parent = this;
	this.instance_5.setTransform(318.45,341.2,1,1,0,0,0,-104.6,-1.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},31).to({state:[]},14).to({state:[{t:this.instance_2}]},1).to({state:[]},13).to({state:[{t:this.instance_3}]},22).to({state:[]},14).to({state:[{t:this.instance_4}]},1).to({state:[]},14).to({state:[{t:this.instance_5}]},30).to({state:[]},14).wait(128));
	...
	var mask_graphics_256 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_257 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_258 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_259 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_260 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_261 = new cjs.Graphics().p("EicGA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_262 = new cjs.Graphics().p("EiW1A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_263 = new cjs.Graphics().p("EiREA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_264 = new cjs.Graphics().p("EiKyA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_265 = new cjs.Graphics().p("EiEBA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_266 = new cjs.Graphics().p("Eh83A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_267 = new cjs.Graphics().p("Eh2GA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_268 = new cjs.Graphics().p("Ehv0A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_269 = new cjs.Graphics().p("EhqDA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_270 = new cjs.Graphics().p("EhkyA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_271 = new cjs.Graphics().p("EhgAA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_272 = new cjs.Graphics().p("EhbvA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_273 = new cjs.Graphics().p("EhX/A9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_274 = new cjs.Graphics().p("EhUuA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_275 = new cjs.Graphics().p("EhR9A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_276 = new cjs.Graphics().p("EhPtA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_277 = new cjs.Graphics().p("EhN8A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_278 = new cjs.Graphics().p("EhMsA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_279 = new cjs.Graphics().p("EhL8A9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_280 = new cjs.Graphics().p("EhLsA9vMAy9h7dMEG1AAAMgy9B7dg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-977.975,y:313.1}).wait(1).to({graphics:mask_graphics_1,x:-889.4657,y:313.1}).wait(1).to({graphics:mask_graphics_2,x:-804.062,y:313.1}).wait(1).to({graphics:mask_graphics_3,x:-721.7639,y:313.1}).wait(1).to({graphics:mask_graphics_4,x:-642.5714,y:313.1}).wait(1).to({graphics:mask_graphics_5,x:-566.4845,y:313.1}).wait(1).to({graphics:mask_graphics_6,x:-493.5032,y:313.1}).wait(1).to({graphics:mask_graphics_7,x:-423.6274,y:313.1}).wait(1).to({graphics:mask_graphics_8,x:-356.8573,y:313.1}).wait(1).to({graphics:mask_graphics_9,x:-293.1927,y:313.1}).wait(1).to({graphics:mask_graphics_10,x:-232.6337,y:313.1}).wait(1).to({graphics:mask_graphics_11,x:-175.1804,y:313.1}).wait(1).to({graphics:mask_graphics_12,x:-120.8326,y:313.1}).wait(1).to({graphics:mask_graphics_13,x:-69.5903,y:313.1}).wait(1).to({graphics:mask_graphics_14,x:-21.4537,y:313.1}).wait(1).to({graphics:mask_graphics_15,x:23.5773,y:313.1}).wait(1).to({graphics:mask_graphics_16,x:65.5028,y:313.1}).wait(1).to({graphics:mask_graphics_17,x:104.3226,y:313.1}).wait(1).to({graphics:mask_graphics_18,x:140.0369,y:313.1}).wait(1).to({graphics:mask_graphics_19,x:172.6456,y:313.1}).wait(1).to({graphics:mask_graphics_20,x:202.1487,y:313.1}).wait(1).to({graphics:mask_graphics_21,x:228.5462,y:313.1}).wait(1).to({graphics:mask_graphics_22,x:251.8381,y:313.1}).wait(1).to({graphics:mask_graphics_23,x:272.0244,y:313.1}).wait(1).to({graphics:mask_graphics_24,x:289.1051,y:313.1}).wait(1).to({graphics:mask_graphics_25,x:303.0803,y:313.1}).wait(1).to({graphics:mask_graphics_26,x:313.9499,y:313.1}).wait(1).to({graphics:mask_graphics_27,x:321.7138,y:313.1}).wait(1).to({graphics:mask_graphics_28,x:326.3722,y:313.1}).wait(1).to({graphics:mask_graphics_29,x:327.925,y:313.1}).wait(1).to({graphics:null,x:0,y:0}).wait(221).to({graphics:mask_graphics_251,x:692.925,y:313.1}).wait(1).to({graphics:mask_graphics_252,x:696.1367,y:313.1}).wait(1).to({graphics:mask_graphics_253,x:705.7716,y:313.1}).wait(1).to({graphics:mask_graphics_254,x:721.8299,y:313.1}).wait(1).to({graphics:mask_graphics_255,x:744.3114,y:313.1}).wait(1).to({graphics:mask_graphics_256,x:773.2163,y:313.1}).wait(1).to({graphics:mask_graphics_257,x:808.5445,y:313.1}).wait(1).to({graphics:mask_graphics_258,x:850.296,y:313.1}).wait(1).to({graphics:mask_graphics_259,x:898.4708,y:313.1}).wait(1).to({graphics:mask_graphics_260,x:953.0689,y:313.1}).wait(1).to({graphics:mask_graphics_261,x:1009.1076,y:313.1}).wait(1).to({graphics:mask_graphics_262,x:1042.83,y:313.1}).wait(1).to({graphics:mask_graphics_263,x:1079.764,y:313.1}).wait(1).to({graphics:mask_graphics_264,x:1119.9097,y:313.1}).wait(1).to({graphics:mask_graphics_265,x:1163.267,y:313.1}).wait(1).to({graphics:mask_graphics_266,x:1209.033,y:313.1}).wait(1).to({graphics:mask_graphics_267,x:1252.3903,y:313.1}).wait(1).to({graphics:mask_graphics_268,x:1292.536,y:313.1}).wait(1).to({graphics:mask_graphics_269,x:1329.47,y:313.1}).wait(1).to({graphics:mask_graphics_270,x:1363.1924,y:313.1}).wait(1).to({graphics:mask_graphics_271,x:1393.7031,y:313.1}).wait(1).to({graphics:mask_graphics_272,x:1421.0021,y:313.1}).wait(1).to({graphics:mask_graphics_273,x:1445.0895,y:313.1}).wait(1).to({graphics:mask_graphics_274,x:1465.9652,y:313.1}).wait(1).to({graphics:mask_graphics_275,x:1483.6293,y:313.1}).wait(1).to({graphics:mask_graphics_276,x:1498.0818,y:313.1}).wait(1).to({graphics:mask_graphics_277,x:1509.3226,y:313.1}).wait(1).to({graphics:mask_graphics_278,x:1517.3517,y:313.1}).wait(1).to({graphics:mask_graphics_279,x:1522.1692,y:313.1}).wait(1).to({graphics:mask_graphics_280,x:1523.775,y:313.1}).wait(1).to({graphics:null,x:0,y:0}).wait(1));

	// Layer_10
	this.instance_6 = new lib.Symbol1copy2("synched",0);
	this.instance_6.parent = this;
	this.instance_6.setTransform(521,367.8,0.01,0.01,0,0,0,240.2,-25);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(226).to({_off:false},0).to({regX:237.3,regY:-29.9,scaleX:1.15,scaleY:1.15,y:367.7},9,cjs.Ease.get(1)).to({regX:237.2,scaleX:1,scaleY:1,x:521.05,y:367.85},9,cjs.Ease.quadInOut).wait(7).to({startPosition:0},0).to({x:584.05},29,cjs.Ease.quadInOut).to({_off:true},1).wait(1));

	// Layer_9
	this.instance_7 = new lib.Symbol6();
	this.instance_7.parent = this;
	this.instance_7.setTransform(53.65,341.45,1.02,1.02);
	this.instance_7.alpha = 0.0117;
	this.instance_7._off = true;

	this.moco = new lib.Symbol6();
	this.moco.name = "moco";
	this.moco.parent = this;
	this.moco.setTransform(512,341.45,1.02,1.02);
	this.moco._off = true;

	var maskedShapeInstanceList = [this.instance_7,this.moco];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(196).to({_off:false},0).to({_off:true,x:512,alpha:1},29,cjs.Ease.quadInOut).wait(57));
	this.timeline.addTween(cjs.Tween.get(this.moco).wait(196).to({_off:false},29,cjs.Ease.quadInOut).wait(26).to({x:539},29,cjs.Ease.quadInOut).to({_off:true},1).wait(1));

	// Layer_8
	this.instance_8 = new lib.Symbol81copy("synched",0);
	this.instance_8.parent = this;
	this.instance_8.setTransform(1343.65,289.95);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(165).to({_off:false},0).to({x:857.95},14,cjs.Ease.get(-1)).to({x:889.95},10,cjs.Ease.quadInOut).wait(7).to({startPosition:0},0).to({x:1108.95},29,cjs.Ease.quadInOut).to({_off:true},1).wait(56));

	// Layer_7
	this.instance_9 = new lib.Symbol81("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(1343.65,131.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(154).to({_off:false},0).to({x:857.95},14,cjs.Ease.get(-1)).to({x:889.95},10,cjs.Ease.quadInOut).wait(18).to({startPosition:0},0).to({x:1145.45},29,cjs.Ease.quadInOut).to({_off:true},1).wait(56));
	...
	this.timeline.addTween(cjs.Tween.get(this.moca).wait(5).to({_off:false},0).wait(1).to({regX:6.8,regY:164.2,x:486.35,y:307.2},0).wait(1).to({x:497.15},0).wait(1).to({x:509.8},0).wait(1).to({x:524.35},0).wait(1).to({x:540.7},0).wait(1).to({x:558.8},0).wait(1).to({x:578.25},0).wait(1).to({x:598.8},0).wait(1).to({x:619.85},0).wait(1).to({x:640.9},0).wait(1).to({x:661.5},0).wait(1).to({x:681.1},0).wait(1).to({x:699.4,y:307.25},0).wait(1).to({x:716.15},0).wait(1).to({x:731.15},0).wait(1).to({x:744.4},0).wait(1).to({x:755.95},0).wait(1).to({x:765.75},0).wait(1).to({x:774},0).wait(1).to({x:780.7},0).wait(1).to({x:786},0).wait(1).to({x:789.95},0).wait(1).to({x:792.7},0).wait(1).to({regX:0,regY:0,x:802.1,y:121.8},0).wait(30).to({regX:-0.1,regY:0.2,scaleX:1.2977,scaleY:1.2977,x:820.2,y:63.2},21,cjs.Ease.quadInOut).wait(30).to({regX:-0.3,regY:0.4,scaleX:1.4469,scaleY:1.4469,x:1273.4,y:6.8},28,cjs.Ease.quadInOut).to({_off:true},1).wait(143));

	// Layer_3
	this.homem = new lib.showAvatarHolograma();
	this.homem.name = "homem";
	this.homem.parent = this;
	this.homem.setTransform(33.45,361.4,1.1299,1.1299,0,0,0,149.6,211);

	var maskedShapeInstanceList = [this.homem];

	for(var shapedInstanceItr = 0; shapedInstanceItr < maskedShapeInstanceList.length; shapedInstanceItr++) {
		maskedShapeInstanceList[shapedInstanceItr].mask = mask;
	}

	this.timeline.addTween(cjs.Tween.get(this.homem).to({x:370.4},29,cjs.Ease.quadInOut).wait(30).to({regX:149.8,regY:211.1,scaleX:1.2978,scaleY:1.2978,x:388.45,y:338.25},21,cjs.Ease.quadInOut).wait(30).to({regX:150,regY:211.2,scaleX:1.4469,scaleY:1.4469,x:499.1,y:313.3},28,cjs.Ease.quadInOut).wait(58).to({x:900.6},29,cjs.Ease.quadInOut).to({_off:true},1).wait(56));

	// Layer 2
	this.instance_10 = new lib.Symbol1("synched",0);
	this.instance_10.parent = this;
	this.instance_10.setTransform(-102,314);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({x:-28,y:311.5},29,cjs.Ease.get(1)).wait(30).to({startPosition:0},0).to({scaleX:1.0404,scaleY:1.0404,x:-49.8,y:301.3},21,cjs.Ease.quadInOut).wait(30).to({startPosition:0},0).to({scaleX:1.147,scaleY:1.147,x:-2.3,y:300.9},28,cjs.Ease.quadInOut).wait(58).to({startPosition:0},0).to({x:70.7},29,cjs.Ease.quadInOut).to({_off:true},1).wait(56));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,1521,696.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"_assets/images/bgNeutro.jpg?1620330220795", id:"bgNeutro"},
		{src:"_assets/images/joia.png?1620330220795", id:"joia"},
		{src:"_assets/images/man_body.png?1620330220795", id:"man_body"},
		{src:"_assets/images/man_boot.png?1620330220795", id:"man_boot"},
		{src:"_assets/images/man_eyebrow.png?1620330220795", id:"man_eyebrow"},
		{src:"_assets/images/man_hair.png?1620330220795", id:"man_hair"},
		{src:"_assets/images/man_hand.png?1620330220795", id:"man_hand"},
		{src:"_assets/images/man_head.png?1620330220795", id:"man_head"},
		{src:"_assets/images/man_pants.png?1620330220795", id:"man_pants"},
		{src:"_assets/images/s5.jpg?1620330220795", id:"s5"},
		{src:"_assets/images/shieldCheck_1.png?1620330220795", id:"shieldCheck_1"},
		{src:"_assets/images/woman_body.png?1620330220795", id:"woman_body"},
		{src:"_assets/images/woman_hair.png?1620330220795", id:"woman_hair"},
		{src:"_assets/images/woman_hand.png?1620330220795", id:"woman_hand"},
		{src:"_assets/images/woman_head.png?1620330220795", id:"woman_head"},
		{src:"_assets/images/woman_pants.png?1620330220795", id:"woman_pants"}
	],
	preloads: []
};
