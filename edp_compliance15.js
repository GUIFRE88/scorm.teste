...
(lib.escritorio = function() {
	this.initialize(img.escritorio);
...
(lib.Symbol30 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("rgba(68,68,68,0.859)").s().p("EhKUAoAMAiVhyUMByUAiVMgiVByUg");

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol30, new cjs.Rectangle(-475.7,-475.7,951.5,951.5), null);
...
(lib.Symbol2 = function(mode,startPosition,loop) {
	...
	// Layer_1
	this.instance = new lib.escritorio();
	this.instance.parent = this;
	this.instance.setTransform(-512,-341.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = getMCSymbolPrototype(lib.Symbol2, new cjs.Rectangle(-512,-341.5,1024,683), null);
...
(lib.__balaocopy8 = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(28.075,-19.825);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#F0F0F0").s().p("AiEiKIDSiAIFnAAIk5CEIowGRg");
	this.shape_1.setTransform(43.725,-26.25);

	this.caixaTexto = new cjs.Text("E é esperado que ao atuar em nome da EDP, nossos parceiros adotem os mesmos valores ao desempenhar suas funções.", "18px 'EDP Preon'", "#333333");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
	this.caixaTexto.lineWidth = 458;
	this.caixaTexto.parent = this;
	this.caixaTexto.setTransform(44.2,-151);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("Egl+gLPMBL9AAKQDIAAAADIIAAQFQAADIjIAAMhL9gAKQjIAAAAjIIAAwFQAAjIDIAAg");
	this.shape_2.setTransform(273.325,-111.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F0F0F0").s().p("Egl+ALGQjIAAAAjIIAAwFQAAjIDIAAMBL9AAKQDIAAAADIIAAQFQAADIjIAAg");
	this.shape_3.setTransform(273.325,-111.2);
...
}).prototype = getMCSymbolPrototype(lib.__balaocopy8, new cjs.Rectangle(-1.5,-184.7,539.5,186.7), null);
...
(lib.__balaocopy = function(mode,startPosition,loop) {
	...
	this.caixaTexto = new cjs.Text("A cultura EDP valoriza a inclusão e a diversidade e não compactua com qualquer discriminação ou tratamento diferenciado em função de credo/religião, idade, imagem \npessoal, etnia ou origem cultural, orientação afetivo sexual, identidade de gênero, deficiência, social, gênero, doenças, \nestado civil, orientação política, opinião ou associação sindical.", "18px 'EDP Preon'", "#333333");
	this.caixaTexto.name = "caixaTexto";
	this.caixaTexto.lineHeight = 27;
	this.caixaTexto.lineWidth = 656;
	this.caixaTexto.parent = this;
	this.caixaTexto.setTransform(32.75,-223.3);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#DF0B14").ss(3,1,1).p("EgyTgQKMBknAAKQDIAAAADIIAAZ7QAADIjIAAMhkngAKQjIAAAAjIIAA57QAAjIDIAAg");
	this.shape_2.setTransform(352.225,-142.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#F0F0F0").s().p("EgyTAQBQjIAAAAjIIAA57QAAjIDIAAMBknAAKQDIAAAADIIAAZ7QAADIjIAAg");
	this.shape_3.setTransform(352.225,-142.7);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.caixaTexto},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.__balaocopy, new cjs.Rectangle(-1.5,-247.7,697.3,249.7), null);
...
// stage content:
(lib.edp_compliance15 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(44).call(this.frame_44).wait(1).call(this.frame_45).wait(54).call(this.frame_99).wait(1).call(this.frame_100).wait(31).call(this.frame_131).wait(1));

	// Layer_5
	this.instance = new lib.btnSeguir();
	this.instance.parent = this;
	this.instance.setTransform(974.3,252.95,0.8047,0.8047,0,0,0,25.6,27.8);
	this.instance._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(44).to({_off:false},0).to({_off:true},1).wait(54).to({_off:false,x:937.75,y:220.95},0).to({_off:true},1).wait(32));

	// Layer_6
	this.instance_1 = new lib.__balaocopy();
	this.instance_1.parent = this;
	this.instance_1.setTransform(204.9,350.15,1,1,0,0,0,-99,55.1);

	this.instance_2 = new lib.__balaocopy8();
	this.instance_2.parent = this;
	this.instance_2.setTransform(298.25,311.75,1,1,0,0,0,-99,55.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_1}]},31).to({state:[]},14).to({state:[{t:this.instance_2}]},41).to({state:[]},14).wait(32));
	...
	var mask_graphics_101 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_102 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_103 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_104 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_105 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_106 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_107 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_108 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_109 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_110 = new cjs.Graphics().p("Eic4A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_111 = new cjs.Graphics().p("EicGA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_112 = new cjs.Graphics().p("EiW1A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_113 = new cjs.Graphics().p("EiREA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_114 = new cjs.Graphics().p("EiKyA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_115 = new cjs.Graphics().p("EiEBA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_116 = new cjs.Graphics().p("Eh83A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_117 = new cjs.Graphics().p("Eh2GA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_118 = new cjs.Graphics().p("Ehv0A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_119 = new cjs.Graphics().p("EhqDA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_120 = new cjs.Graphics().p("EhkyA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_121 = new cjs.Graphics().p("EhgAA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_122 = new cjs.Graphics().p("EhbvA9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_123 = new cjs.Graphics().p("EhX/A9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_124 = new cjs.Graphics().p("EhUuA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_125 = new cjs.Graphics().p("EhR9A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_126 = new cjs.Graphics().p("EhPtA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_127 = new cjs.Graphics().p("EhN8A9vMAy9h7dMEG0AAAMgy9B7dg");
	var mask_graphics_128 = new cjs.Graphics().p("EhMsA9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_129 = new cjs.Graphics().p("EhL8A9vMAy9h7dMEG1AAAMgy9B7dg");
	var mask_graphics_130 = new cjs.Graphics().p("EhLsA9vMAy9h7dMEG1AAAMgy9B7dg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:mask_graphics_0,x:-977.975,y:313.1}).wait(1).to({graphics:mask_graphics_1,x:-889.4657,y:313.1}).wait(1).to({graphics:mask_graphics_2,x:-804.062,y:313.1}).wait(1).to({graphics:mask_graphics_3,x:-721.7639,y:313.1}).wait(1).to({graphics:mask_graphics_4,x:-642.5714,y:313.1}).wait(1).to({graphics:mask_graphics_5,x:-566.4845,y:313.1}).wait(1).to({graphics:mask_graphics_6,x:-493.5032,y:313.1}).wait(1).to({graphics:mask_graphics_7,x:-423.6274,y:313.1}).wait(1).to({graphics:mask_graphics_8,x:-356.8573,y:313.1}).wait(1).to({graphics:mask_graphics_9,x:-293.1927,y:313.1}).wait(1).to({graphics:mask_graphics_10,x:-232.6337,y:313.1}).wait(1).to({graphics:mask_graphics_11,x:-175.1804,y:313.1}).wait(1).to({graphics:mask_graphics_12,x:-120.8326,y:313.1}).wait(1).to({graphics:mask_graphics_13,x:-69.5903,y:313.1}).wait(1).to({graphics:mask_graphics_14,x:-21.4537,y:313.1}).wait(1).to({graphics:mask_graphics_15,x:23.5773,y:313.1}).wait(1).to({graphics:mask_graphics_16,x:65.5028,y:313.1}).wait(1).to({graphics:mask_graphics_17,x:104.3226,y:313.1}).wait(1).to({graphics:mask_graphics_18,x:140.0369,y:313.1}).wait(1).to({graphics:mask_graphics_19,x:172.6456,y:313.1}).wait(1).to({graphics:mask_graphics_20,x:202.1487,y:313.1}).wait(1).to({graphics:mask_graphics_21,x:228.5462,y:313.1}).wait(1).to({graphics:mask_graphics_22,x:251.8381,y:313.1}).wait(1).to({graphics:mask_graphics_23,x:272.0244,y:313.1}).wait(1).to({graphics:mask_graphics_24,x:289.1051,y:313.1}).wait(1).to({graphics:mask_graphics_25,x:303.0803,y:313.1}).wait(1).to({graphics:mask_graphics_26,x:313.9499,y:313.1}).wait(1).to({graphics:mask_graphics_27,x:321.7138,y:313.1}).wait(1).to({graphics:mask_graphics_28,x:326.3722,y:313.1}).wait(1).to({graphics:mask_graphics_29,x:327.925,y:313.1}).wait(1).to({graphics:null,x:0,y:0}).wait(71).to({graphics:mask_graphics_101,x:692.925,y:313.1}).wait(1).to({graphics:mask_graphics_102,x:696.1367,y:313.1}).wait(1).to({graphics:mask_graphics_103,x:705.7716,y:313.1}).wait(1).to({graphics:mask_graphics_104,x:721.8299,y:313.1}).wait(1).to({graphics:mask_graphics_105,x:744.3114,y:313.1}).wait(1).to({graphics:mask_graphics_106,x:773.2163,y:313.1}).wait(1).to({graphics:mask_graphics_107,x:808.5445,y:313.1}).wait(1).to({graphics:mask_graphics_108,x:850.296,y:313.1}).wait(1).to({graphics:mask_graphics_109,x:898.4708,y:313.1}).wait(1).to({graphics:mask_graphics_110,x:953.0689,y:313.1}).wait(1).to({graphics:mask_graphics_111,x:1009.1076,y:313.1}).wait(1).to({graphics:mask_graphics_112,x:1042.83,y:313.1}).wait(1).to({graphics:mask_graphics_113,x:1079.764,y:313.1}).wait(1).to({graphics:mask_graphics_114,x:1119.9097,y:313.1}).wait(1).to({graphics:mask_graphics_115,x:1163.267,y:313.1}).wait(1).to({graphics:mask_graphics_116,x:1209.033,y:313.1}).wait(1).to({graphics:mask_graphics_117,x:1252.3903,y:313.1}).wait(1).to({graphics:mask_graphics_118,x:1292.536,y:313.1}).wait(1).to({graphics:mask_graphics_119,x:1329.47,y:313.1}).wait(1).to({graphics:mask_graphics_120,x:1363.1924,y:313.1}).wait(1).to({graphics:mask_graphics_121,x:1393.7031,y:313.1}).wait(1).to({graphics:mask_graphics_122,x:1421.0021,y:313.1}).wait(1).to({graphics:mask_graphics_123,x:1445.0895,y:313.1}).wait(1).to({graphics:mask_graphics_124,x:1465.9652,y:313.1}).wait(1).to({graphics:mask_graphics_125,x:1483.6293,y:313.1}).wait(1).to({graphics:mask_graphics_126,x:1498.0818,y:313.1}).wait(1).to({graphics:mask_graphics_127,x:1509.3226,y:313.1}).wait(1).to({graphics:mask_graphics_128,x:1517.3517,y:313.1}).wait(1).to({graphics:mask_graphics_129,x:1522.1692,y:313.1}).wait(1).to({graphics:mask_graphics_130,x:1523.775,y:313.1}).wait(1).to({graphics:null,x:0,y:0}).wait(1));

	// Layer_3
	this.moca = new lib.showAvatarHolograma2();
	this.moca.name = "moca";
	this.moca.parent = this;
	this.moca.setTransform(-620.7,63.2,1.2977,1.2977,0,0,180,-0.1,0.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.moca).to({x:202.25},29,cjs.Ease.get(1)).wait(16).to({regY:0.3,scaleX:1.5022,scaleY:1.5022,x:258.95,y:-9.45},39,cjs.Ease.quadInOut).wait(17).to({x:483.95},29,cjs.Ease.quadInOut).to({_off:true},1).wait(1));

	// Layer_4
	this.instance_3 = new lib.Symbol30();
	this.instance_3.parent = this;
	this.instance_3.setTransform(-594.2,333.6,1,1,-29.8946);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).to({rotation:0,x:54.05},29,cjs.Ease.get(1)).wait(16).to({regX:0.1,regY:0.1,scaleX:1.1025,scaleY:1.1025,x:95.7,y:333.65},39,cjs.Ease.quadInOut).wait(17).to({x:212.7},29,cjs.Ease.quadInOut).to({_off:true},1).wait(1));

	// Layer 2
	this.instance_4 = new lib.Symbol2();
	this.instance_4.parent = this;
	this.instance_4.setTransform(439,317.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).to({x:513,y:315},29,cjs.Ease.get(1)).wait(16).to({scaleX:1.05,scaleY:1.05,x:532.55,y:314},39,cjs.Ease.quadInOut).wait(17).to({x:568.55},29,cjs.Ease.quadInOut).to({_off:true},1).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-731.7,0,1837.9,858.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"_assets/images/escritorio.jpg?1620330027418", id:"escritorio"},
		{src:"_assets/images/woman_body.png?1620330027418", id:"woman_body"},
		{src:"_assets/images/woman_hair.png?1620330027418", id:"woman_hair"},
		{src:"_assets/images/woman_hand.png?1620330027418", id:"woman_hand"},
		{src:"_assets/images/woman_head.png?1620330027418", id:"woman_head"},
		{src:"_assets/images/woman_pants.png?1620330027418", id:"woman_pants"}
	],
	preloads: []
};
