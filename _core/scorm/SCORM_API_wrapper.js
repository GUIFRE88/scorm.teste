        ...
        if(API){
             ...
             if(scorm.handleExitMode && !exitStatus){
                ...
                if(completionStatus !== "completed" && completionStatus !== "passed"){
                    ...
                    var cmiExit = nav.ScormExit ? nav.ScormExit : null; 

                    switch(scorm.version){
                        case "1.2" : 
                            if(nav.ScormExit){ // SCORM 1.2 on completed = cmi.exit logout ou suspend
                                success = scorm.set("cmi.core.exit", nav.ScormExit); 
                            } else {
